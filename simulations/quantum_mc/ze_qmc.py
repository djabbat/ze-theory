...
ПРИМЕЧАНИЕ: режим --quick использует M_trotter=16 (Δτ=0.625).
Систематическая ошибка троттеризации ~O(Δτ²)≈0.39 существенна.
Для точных результатов используйте Rust-симулятор (v2.1, M_trotter=32).
"""
